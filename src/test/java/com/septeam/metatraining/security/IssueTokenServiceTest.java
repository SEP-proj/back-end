package com.septeam.metatraining.security;
...
class IssueTokenServiceTest {
    ...
    void testIssueTokenByUserPrincipal() {
        ...
        when(issueTokenService.issueTokenByUserPrincipal(userPrincipal))
    ...
    void testIssueTokenByAccessToken() {
        when(issueTokenService.issueTokenByAccessToken(defaultAccessToken))
                .thenReturn(anyString());
